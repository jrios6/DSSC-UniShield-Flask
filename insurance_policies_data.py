...
item1["recommend"] = "Recommended because of medical history"
...
item3["recommend"] = "Recommended because of dengue danger level near home address"

item4 = dict()
item4["url"] = "../static/img/healthpicture.png"
item4["title"] = "Hospitalisation Insurance"
item4["htitle"] = "#Hospitalisation Insurance"
item4["summary"] = "The hospitalisation insurance keeps you protected so you don't have to worry about anything! "
...
item6 = dict()
item6["url"] = "../static/img/family.png"
item6["title"] = "Family Insurance"
item6["htitle"] = "#Family Insurance"
item6["summary"] = "Love your family? Keep everyone protected with our affordable family plan."
item6["coverage"] = "$15000 or $20000 sum assured"
item6["pricing"] = "Starting from $80/yr"
item6["recommend"] = "Recommended because of dependents"

RECOMMENDED_POLICIES = [item1, item2, item3]
RECOMMENDED_POLICIES1 = [item4, item5, item6]
...
cp1["status"] = "Covered"
cp1["coverage-you"] = "$40,000"
cp1["coverage-others"] = "$40,000"
...
cp2["status"] = "Covered"
cp2["coverage-you"] = "$11,000"
cp2["coverage-others"] = "$10,000"
...
cp3["status"] = "Covered"
cp3["coverage-you"] = "$60,000"
cp3["coverage-others"] = "$60,000"
...
cp4["status"] = "Covered"
cp4["coverage-you"] = "$10,000"
cp4["coverage-others"] = "$10,000"
...
cp7["coverage-others"] = "$1,500"

CURRENT_POLICIES = [cp1, cp2, cp3, cp4]
CURRENT_POLICIES1 = [cp5, cp6, cp7]
